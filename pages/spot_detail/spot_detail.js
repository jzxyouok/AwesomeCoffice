...
Page({
  ...
  bindCheckViewTap: function(event) {
    ...
    var spot_id = event.currentTarget.id.split('@')[0]
    var spot_name = event.currentTarget.id.split('@')[1]
    var check_request_url = "http://45.55.9.229/api/v1/comments/?format=json"
    wx.request({
      method: 'POST',
      data: {
         'spot_id': spot_id,
  ...
  onLoad: function (options) {
    ...
    var request_url = "http://45.55.9.229/api/v1/spots/" + spot_id + "/?format=json"
    wx.request({
      url: request_url,
      header: {
    ...
    var spot_comment_list_request_url = "http://45.55.9.229/api/v1/spot_comment_list/" + spot_id + "/?format=json"
    wx.request({
